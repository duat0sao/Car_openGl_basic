...
void display(void)
{
	...
	glutSolidCube(0.5); //hiển thị 1 khối 
	glPopMatrix();

	//Vẽ ngăn xếp thân trên hình.
	glPushMatrix();
	glTranslatef((GLfloat)dichchuyen / 6, (GLfloat)dichchuyen / 6, 0);
	setMaterial(3.0, 6.0, 7.0, 0.6, 0.6, 6.0, 1.0, 1.0, 1.0, 50);
